...
- (EOAdaptorChannel *)createAdaptorChannel
{
   PostgreSQLChannel		*channel;
	...
	channel = [[PostgreSQLChannel allocWithZone:[self zone]] initWithAdaptorContext:self];
...
- (void)beginTransaction
{
   ...
   [super beginTransaction];
	[(PostgreSQLChannel *)[self transactionChannel] executeSQL:@"BEGIN"];
...
- (void)commitTransaction
{
   ...
   if ([self hasOpenTransaction]) {
      [(PostgreSQLChannel *)[self transactionChannel] executeSQL:@"COMMIT"];
...
- (void)rollbackTransaction
{
   ...
   if ([self hasOpenTransaction]) {
		[(PostgreSQLChannel *)[self transactionChannel] executeSQL:@"ROLLBACK"];
