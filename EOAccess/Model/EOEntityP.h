...
// If YES, then we generate the primary keys. Basically, this indicates that none of the primary key attributes are class properties.
- (BOOL)_primaryKeyIsPrivate;

// If YES, we can use an optimized version of the global id.
